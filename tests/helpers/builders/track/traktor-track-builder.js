...
/** @returns {TraktorTrack} */
export function aTraktorTrack(/** Track */ track) {
    return ({
        ...aTrack,
        volume: '',
        directory: '',
...
/** @returns {TraktorTrack} */
export function withDirectory(/** string */ directory, /** TraktorTrack */ track) {
    return ({
        ...track,
        directory: '/:' + directory
            .replace(/^\//, '')
...
/** @returns {TraktorTrack} */
export function withFilename(/** string */ filename, /** TraktorTrack */ track) {
    return {...track, filename}
}

/** @returns {TraktorTrack} */
export function withVolume(/** string */ volume, /** TraktorTrack */ track) {
    return {
        ...track,
...
/** @returns {string} */
export function buildTraktorTrack(/** TraktorTrack */ track) {
